...
export default function Login() {
  ...
  React.useEffect(() => {
    ...
    if (error) {
      ...
      if (error === 'google_auth_failed') errorMessage = 'Google authentication failed';
      if (error === 'microsoft_auth_failed') errorMessage = 'Microsoft authentication failed';
      if (error === 'linkedin_auth_failed') errorMessage = 'LinkedIn authentication failed';
